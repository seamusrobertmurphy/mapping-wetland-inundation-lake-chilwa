...
: "Integrated Remote Sensing and Commuity Mapping of an Endorheic Wetland in Southern Malawi" 
...
= "Regional Context: Lake Chilwa Basin",
    x = "Longitude", 
    y = "Latitude"
  ) + 
  theme_minimal() +
